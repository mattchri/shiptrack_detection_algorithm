;Example
;TrackPixels = AUTO_EXECUTE( [496,525,556,578,625,673,723,780],
;[683,711,736,756,791,816,842,874],
;HDF_FILE='/group_workspaces/cems2/nceo_generic/satellite_data/modis_c6/mod021km/2002/150/MOD021KM.A2002150.1855.006.2014231005506.hdf',HDF_FILE_CHANNEL=HDF_FILE_CHANNEL, /PLOT_TRACK)


FUNCTION AUTO_EXECUTE,xDev,yDev,ModisImage=ModisImage,HDF_FILE=HDF_FILE,PLOT_TRACK=PLOT_TRACK

;Define thresholds for detection algorithm
sigma_thresh = 4.
...
trk_pos_ct = N_ELEMENTS( xDev ) ;# of track bends
 ...
 ;Re-construct ship track postion (increase resolution between hand-logged locations) 
 ...
 ;calculate coordinates (along track and cross track) for each segment
 ...
 ;Go through the control and ship masks to remove repeated values
 ...
 ;Save pixels into arrays
 str_px_loc = ['modis-x','modis-y','seg#','along-track distance (km)','ship-track width at along-track pixel (km)']
...
shiptrack_pixels = { ship:ship_px_loc, con1:con1_px_loc, con2:con2_px_loc, str:str_px_loc,$
